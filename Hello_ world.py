...
# TIPS: Pentru a comenta sau a scoate comentariile de pe o portiune mai mare de cod, selectati bucata de cod ce o
# vreti comentata si apasati CTRL + / (pentru Windows) SAU CMD + / (pentru Mac OS)
...
# comparam valoarea variabilei varsta cu 30, daca valoarea nu este 30, atunci se afiseaza mesajul de eroare,
# iar codul nu curge mai departe
...
# ex 2: utilizatorul va introduce de la tastura un numar intreg pe care il vom aduna cu valoarea variabilei b din
# moment ce orice va introduce utilizatorul este de tip string, valoarea trebuie convertita in int pt a o putea aduna
# la val lui b Avem 2 variante:
...
lungime = len(
    c)  # am creat variabila lungime in care stocam outputul functiei len(c), adica numarul de caractere din stringul
# "vreau acasa"
