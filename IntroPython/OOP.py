...
class Student:
    ...
    def __init__(self, nume, prenume, medie):
        ...
        # Referirea la variabila de clasă numar_studenti se face cu notaţia Student.numar_studenti şi nu cu
        # self.numar_studenti
    ...
    # O variabilă de obiect cu același nume ca o variabilă de clasă, va ascunde variabila de clasă faţă de metodele
    # clasei! Metoda nr_studenti este în fapt o metodă  a clasei şi nu a instanţei. Asta înseamnă că trebuie să o
    # definim cu declaraţia static method.
