...
# daca argumentele unei functii liste si dictionare
# args = [2, 5, 7]
...
# l.sort(key=lambda x: x[1]) # x este parametrul pt functie si returnam x[1] adica al doilea element din fiecare
# nested list print(l)
