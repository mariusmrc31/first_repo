...
"""
O variabila o adresa de memorie in care putem sa stocam informatii.
Ele pot fi de mai multe feluri: Intregi, sir de caractere, boolean, float
"""
...
# Ex_8 - Având stringul: 'Coral is either the stupidest animal or the smartest rock' afișează de câte ori apare
# cuvântul 'the' în acest string
prop = 'Coral is either the stupidest animal or the smartest rock'
print(prop.count(' the '))

# EX_9 Folosindu-te de string-ul de la exercițiul 8, inlocuieste “the” cu “THE” peste tot (inclusiv in cuvantul
# “either”) si afișează pe ecran rezultatul
prop = 'Coral is either the stupidest animal or the smartest rock'
print(f'{prop.replace("the", "THE")}')

# Ex_10 Folosindu-te de string-ul de la exercițiul 8 foloseste un assert ca să verifici dacă acest string conține
# doar numere.
prop = 'Coral is either the stupidest animal or the smartest rock'
...
# Ex_3 - Citește de la tastatură un string care sa fie format din doua cuvinte (ex: 'alabala portocala') asupra
# caruia sa efectuezi urmatoarele: salvează fiecare cuvânt într-o variabilă; printează ambele variabile pentru
# verificare.
text = str(input('Scrie un string: '))
x, y = text.split(' ')
...
# Ex_5 - Citeste de la tastatura un user si o parola. Afiseaza pe ecran urmatoarea propizitie: 'Parola pt userul x
# este ***** si are x caractere'.
